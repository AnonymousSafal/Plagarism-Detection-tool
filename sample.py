...
load_button1 = tk.Button(frame, text="Load File 1",
                         command=lambda: load_file_or_display_contents(file_entry1, text_textbox1))
...
load_button2 = tk.Button(frame, text="Load File 2",
                         command=lambda: load_file_or_display_contents(file_entry2, text_textbox2))
